...
namespace Infrastructure.Features
{
    public partial class CustomersList : Form
    {
        ...
        private void buttonGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            GenerateReport(responseGetAllCustomers.Customers, responseGetAllCustomers.TotalDebts, responseGetAllCustomers.TotalCustomer, responseGetAllCustomers.AverageDebts);

        }

        private void GenerateReport(List<Customer> customers,int totalDebts, int totalCustomer, float averageDebts)
        {
